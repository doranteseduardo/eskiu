...
- `--asan` instruments the build with AddressSanitizer (via the LLVM pass manager) and links the matching compiler-rt runtime. It catches use-after-free, out-of-bounds, and leaks at the point of the bad access.
