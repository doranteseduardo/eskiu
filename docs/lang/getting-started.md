...
All code blocks in this document compile and run with **Eskiu v0.2.4**.
---
...
# Eskiu 0.2.4 (LLVM 22.1.6)   — exact LLVM version depends on your install
```
...
### Standard library highlights (v0.2.4)
